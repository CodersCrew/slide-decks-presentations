...
export default {
  slides: [
    ...
    },
    {
      ...
      content: {
        image: '/static/are-you-a-programmer.png',
      },
    },
    {
      ...
      content: {
        ...
        items: [
          {
            icon: '/static/icons/light/user.svg',
          },
          {
            icon: '/static/icons/light/comments.svg',
          },
          {
            icon: '/static/icons/light/laptop-code.svg',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      content: {
        ...
        items: [
          {
            icon: '/static/icons/light/history.svg',
            title: 'Pojawił się w 1995 roku.',
          },
          {
            icon: '/static/icons/light/building.svg',
            title: 'Stworzony przez firmę Netscape.',
          },
          {
            icon: '/static/icons/light/browser.svg',
          ...
          {
            icon: '/static/icons/light/suitcase.svg',
            title: 'Drugi najbardziej pożądany przez pracodawców język',
          },
          {
            icon: '/static/icons/brands/js.svg',
    ...
    },
    {
      ...
      content: {
        ...
        items: [
          ...
          {
            image: '/static/variables_name.png',
          },
          {
            title:
    ...
    },
    {
      ...
      content: {
        ...
        items: [
          ...
          {
            image: '/static/value_attribution.png ',
          },
        ],
      },
    },
