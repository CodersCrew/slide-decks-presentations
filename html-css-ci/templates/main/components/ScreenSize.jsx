  ...
  render() {
    ...
    return (
      <Container id="container" style={toggleSizeButton}>
        <Switch style={changeCursor} disabled={!this.state.isVisible} onClick={this.toggleScreen}>
          <img src={this.state.isFullScreen ? '/static/icons/small_size.svg' : '/static/icons/full_size.svg'} />
        </Switch>
      </Container>
    );
  }
