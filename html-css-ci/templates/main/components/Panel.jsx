      ...
      <Container id="container" style={toggleButtonStyle}>
        <Wrapper id="wrapper" onClick={e => e.stopPropagation()} className={this.state.isMinimized ? 'show' : null}>
          <Arrows className="arrows">
            <LeftArrow style={changeCursor} disabled={!this.state.isVisible} onClick={prevSlide}>
              <img src="/static/icons/small_arrow_up.svg" />
            </LeftArrow>
            <SlideNumber className="slide-number">
              <p>
                {' '}
                {actualSlide + 1}|{slides}{' '}
              </p>
            </SlideNumber>
            <RightArrow style={changeCursor} onClick={nextSlide}>
              <img src="/static/icons/small_arrow_up.svg" />
            </RightArrow>
          </Arrows>
          <button style={changeCursor} disabled={!this.state.isVisible} onClick={newTheme}>
            <img src="/static/icons/theme_btn.svg" />
          </button>
        </Wrapper>
        <ShowIcon style={changeCursor} disabled={!this.state.isVisible} onClick={this.toggleToolbar}>
          <img className={this.state.isMinimized ? 'show' : null} src="/static/icons/small_arrow_up.svg" />
        </ShowIcon>
      </Container>
    );
  }
