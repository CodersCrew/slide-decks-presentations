...
})(["display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:url('", "') no-repeat center/cover;opacity:0.75;", ""], function (props) {
  return props.image;
}, function (props) {
  return props.styles;
});
...
})(["width:1440px;height:800px;border-radius:8px;background-color:var(--slide-background);"]);
...
//# sourceMappingURL=index.js.1ffc88c69932c2a6ec0d.hot-update.js.map